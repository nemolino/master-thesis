...
class Master:
    ...
    def optimize(self, still_to_fix=None):
        ...
        η = []
        for n in range(N):
            if still_to_fix is not None and n not in still_to_fix:
                η.append(None)
            else:
...
class ColumnGeneration:
    ...
    def execute(self):
        ...
        for n in range(N):
            ...
            print(f"{n}-th heuristic pricing build")
        ...
        #     print(f"discrete RMP fail 1")
        # end_discrete = perf_counter()
        # print(f"discrete RMP time : {end_discrete-start_discrete:.2f} s\n\n")
